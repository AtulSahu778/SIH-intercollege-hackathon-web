...
export const metadata: Metadata = {
  title: `Upload Authorization Letter — ${HACKATHON.name}`,
  description: `Submit your college authorization letter for the Internal SIH 2026 at ${COLLEGE.name} using your assigned SIH Team ID.`,
};

export default function AuthLetterUploadPage() {
  return (
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-24 pb-8 sm:pt-36 sm:pb-14">
          <div className="max-w-2xl">
            <div className="inline-flex items-center gap-1.5 sm:gap-2 px-3 py-1 rounded-full bg-white/10 border border-white/15 text-[11px] sm:text-xs font-semibold text-white/90 mb-3 sm:mb-4">
              ...
              Registration Closed · Authorization Letter Submission
            </div>
            ...
            <p className="mt-2 text-xs sm:text-sm md:text-base text-white/70 leading-relaxed max-w-xl">
              Registrations are closed. Registered teams can submit their completed
              letter using their assigned <span className="text-white font-semibold">SIH Team ID</span>.
            </p>
          </div>
        </div>
      </div>

      {/* Upload Component Body */}
