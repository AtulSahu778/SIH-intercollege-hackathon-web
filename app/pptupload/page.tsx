...
export default function PresentationUploadPage() {
  return (
    <section className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-slate-100 py-16 sm:py-24 px-4">
      {/* Page Header */}
      <div className="max-w-xl mx-auto text-center mb-8 sm:mb-12">
        <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-navy-primary/5 border border-navy-primary/10 text-navy-primary text-[11px] sm:text-xs font-bold tracking-wide uppercase mb-4">
